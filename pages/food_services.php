...
$category = 'اطعام'; // الفئة الخاصة بهذه الصفحة
...
<head>
<meta charset="UTF-8">
<title>خدمات الأطعام - وادي سوف</title>
...
<nav class="navbar mb-4">
  <div class="container">
    ...
    <span class="text-white">/ الأطعام</span>
  </div>
</nav>

<div class="container">
<h2 class="mb-4">خدمات الأطعام</h2>

<!-- صندوق البحث -->
<input type="text" id="search" class="form-control mb-4" placeholder="ابحث عن خدمة الأطعام...">
