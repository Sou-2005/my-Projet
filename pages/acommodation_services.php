...
$category = 'اقامات'; // الفئة الخاصة بهذه الصفحة
...
<head>
<meta charset="UTF-8">
<title>خدمات الاقامات  - وادي سوف</title>
...
<nav class="navbar mb-4">
  <div class="container">
    ...
    <span class="text-white">/ الاقامات</span>
  </div>
</nav>

<div class="container">
<h2 class="mb-4">خدمات الاقامات</h2>

<!-- صندوق البحث -->
<input type="text" id="search" class="form-control mb-4" placeholder="ابحث عن خدمة الاقامة...">
